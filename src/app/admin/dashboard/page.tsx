  ...
  return (
    <div className="min-h-screen bg-white py-8">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 space-y-8">
        {/* Admin Header */}
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 rounded-2xl bg-[#024AE5] p-6 sm:p-8 text-white shadow-lg">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <Badge className="bg-[#3C8B4F] text-white border-0">
          ...
          <div className="flex items-center gap-3">
            <Link href="/dashboard">
              <Button size="sm" className="bg-white text-[#024AE5] hover:bg-slate-100 text-xs font-semibold shadow-xs">
                Customer View
              </Button>
            </Link>
        ...
        <Card className="border-slate-200 bg-white">
          <CardHeader className="flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-slate-100 pb-4 gap-2">
            <div>
              <CardTitle className="text-lg font-bold text-slate-900">Global Ecommerce Orders</CardTitle>
        ...
        <Card className="border-slate-200 bg-white">
          <CardHeader className="border-b border-slate-100 pb-4">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-lg font-bold text-slate-900">Registered B2B Client Directory</CardTitle>
            </div>
            <CardDescription className="text-xs">
